...
public class HkdFunctionTest {
    ...
    public void testExpandLong() throws NoSuchAlgorithmException {
        ...
        System.out.println(Util.bytesToHexString(expand));
        ...
        expand = HkdFunction.expand(Util.hexStringToByteArray("3b7a839c239ef2bf0b7305a0e0c4e5a8c6c69330a753b308f5e3a83aa2ef6979"), Util.hexStringToByteArray("001009746c733133206b657900"), 10240);
        MessageDigest hashFunction = MessageDigest.getInstance("SHA-256");
        expand = hashFunction.digest(expand);
        System.out.println(Util.bytesToHexString(expand));
        assertArrayEquals(Util.hexStringToByteArray("376566cb205c715ad6dcbc14afdd1d70fb88c7ff7e6688aff3b0e8d0a4c4956d"), expand);// compare to a Hash to save a short compare value
        }
