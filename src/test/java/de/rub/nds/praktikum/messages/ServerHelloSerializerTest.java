...
public class ServerHelloSerializerTest {
    ...
    public void testSerializeBytes() {
        ...
        ServerHello hello = new ServerHello(ProtocolVersion.TLS_1_1, Util.hexStringToByteArray("00112233445566778899AABBCCDDEEFFFFEEDDCCBBAA99887766554433221100"), Util.hexStringToByteArray("FFEEDDCCBBAA9988776655443322110000112233445566778899AABBCCDDEEFF"), CipherSuite.TLS_AES_128_GCM_SHA256, CompressionMethod.NULL, extensionList);
        ...
        hello = new ServerHello(ProtocolVersion.TLS_1_2, Util.hexStringToByteArray("3b2910cd0a3711b8a249244a9a5b1fd120580167552e171616e05dfde5b1a727"), Util.hexStringToByteArray("779b65b6b9796bd974acca5119f54ebd65a73ec9e372faf8fca04e051f271e15"), CipherSuite.TLS_AES_256_GCM_SHA384, CompressionMethod.NULL, extensionList);
