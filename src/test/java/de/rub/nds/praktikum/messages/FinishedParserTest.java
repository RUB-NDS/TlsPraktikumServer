...
public class FinishedParserTest {
    ...
    public void testParse() {
        ...
        assertArrayEquals("verify_data was parsed incorrectly",Util.hexStringToByteArray("FFEEDDCCBBAA9988776655443322110000112233445566778899AABBCCDDEEFF"), parsedFinished.getVerifyData());
    }
