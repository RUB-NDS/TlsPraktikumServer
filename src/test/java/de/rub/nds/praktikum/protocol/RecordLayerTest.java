...
public class RecordLayerTest {
    ...
    /**
     * Tests that if we send 100 records and receive the same 100 records that
     *
     * @throws Exception
     */
    @Test
    ...
    public void testCryptWithSeqNumber100() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            assertArrayEquals("Error in test " + i, Util.hexStringToByteArray("123456789F"), receivedRecords.get(i).getData());
        }
    }
    ...
    public void testReceiveEncrypedData() throws Exception {
        ...
        assertArrayEquals(Util.hexStringToByteArray("123456789F"), records.get(1).getData());
    }
    ...
    public void testReceiveData() throws Exception {
        ...
        assertEquals(0x33, testRecord.getType());
        ...
        assertEquals(8, receivedRecords.size());
    }
    ...
    public void testSendMulitpleRecordData() throws IOException {
        ...
        assertEquals(245, reparsedRecordList.size());
    }
}
